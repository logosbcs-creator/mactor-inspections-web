    ...
    <div style={{ minHeight: "100dvh", background: "#f8fafc", fontFamily: "-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif", color: "#111" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 12, marginBottom: 24 }}>
          {[
            { label: "Clientes totales", value: clients.length,                       color: "#0f172a", fmt: "n" },
            { label: "Total facturado",  value: clients.reduce((s,c)=>s+c.totalInvoiced,0), color: "#7c3aed", fmt: "$" },
            { label: "Total cobrado",    value: totalPaid,                             color: "#16a34a", fmt: "$" },
        ...
        <div style={{ display: "grid", gridTemplateColumns: selected ? "1fr 420px" : "1fr", gap: 16 }}>
          ...
          <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #e2e8f0", overflow: "hidden" }}>
            ...
            {/* Table header */}
            <div style={{ display: "grid", gridTemplateColumns: "1fr 110px 100px 90px 80px", padding: "10px 20px", background: "#f8fafc", borderBottom: "1px solid #e2e8f0" }}>
            ...
            {loading ? (
              ...
              <div key={c.id} onClick={() => select(c)}
                style={{ display: "grid", gridTemplateColumns: "1fr 110px 100px 90px 80px", padding: "14px 20px",
          ...
          {/* Detail panel */}
          {selected && (
            <div style={{ background: "#fff", borderRadius: 12, border: "1px solid #e2e8f0", overflow: "hidden", height: "fit-content" }}>
